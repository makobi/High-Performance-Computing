...
int main(int argc, char** argv)
{
	...
	our_cardinality += NUMBER_OF_PROCESSES; 
    #endif
	...
	our_cardinality += omp_get_num_threads();
    #endif
...
#ifdef STAT_KIT
	if (our_cardinality == 0)
		our_cardinality = 1; 
        printStats("Are Under Curve",our_cardinality,"mpi",NUMBER_OF_RECTANGLES, "1", 0, 0);
#endif
